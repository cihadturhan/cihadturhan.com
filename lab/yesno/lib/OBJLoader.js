...
THREE.OBJLoader = function(manager, material) {

    this.manager = (manager !== undefined) ? manager : THREE.DefaultLoadingManager;
    this.material = (material !== undefined) ? material : new THREE.MeshPhongMaterial({ambient: 0x555555, color: 0xFFFFFF, specular: 0x111111, shininess: 30});//new THREE.MeshPMaterial();;
...
THREE.OBJLoader.prototype = {
    ...
    parse: function(text) {
        ...
        var geometry, material = this.material, mesh;
